(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/forms'),require('@angular/common'),exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('ng-starrating', ['@angular/core','@angular/forms','@angular/common','exports', '@angular/core', '@angular/forms', '@angular/common', 'rxjs'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.forms,global.ng.common,global['ng-starrating'] = {}, global.ng.core, global.ng.forms, global.ng.common, global.rxjs));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, forms, common, rxjs) { 
var _c0 = ["starMain"];
'use strict';
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(StarRatingComponent, [{
        type: core.Component,
        args: [{ selector: 'star-rating', template: "<div #starMain>\n</div>", encapsulation: core.ViewEncapsulation.ShadowDom, styles: [":root{--checkedColor:gold;--unCheckedColor:gray;--size:24px;--halfWidth:10px;--halfMargin:-20px}.star{cursor:pointer;color:var(--unCheckedColor);font-size:var(--size);width:var(--size);display:inline-block}.star:last-child{margin-right:0}.star:before{content:'\\2605'}.star.on{color:var(--checkedColor)}.star.half:after{content:'\\2605';color:var(--checkedColor);position:absolute;margin-left:var(--halfMargin);width:var(--halfWidth);overflow:hidden}"] }]
...
RatingModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [forms.FormsModule,
        common.CommonModule] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(RatingModule, { declarations: [RatingComponent, StarRatingComponent], imports: [ɵngcc1.FormsModule, ɵngcc2.CommonModule], exports: [StarRatingComponent] }); })();
        return RatingModule;
    }());
